...
const parseKeywords_1 = __importDefault(require("./utils/parseKeywords"));
/**
 *
 * Filter.
 *
...
function filter(data, options = {}) {
    ...
    if (typeof keywords === 'string') {
        keywords = (0, parseKeywords_1.default)(keywords);
    }
    ...
    if (index) {
        ...
        for (let i = 0; i < data.length && matched < limit; i++) {
            if ((0, match_1.default)(data[i], criteria, predicate, { ignorePaths, pathAlias })) {
...
},{"./match/match":3,"./utils/convertKeywordsToCriteria":6,"./utils/ensureObjectOfRegExps":7,"./utils/parseKeywords":10,"lodash.escaperegexp":1}],3:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"./getCheckNumber":8,"./getCheckString":9,"lodash.escaperegexp":1}],7:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
},{"lodash.escaperegexp":1}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const operators = {
    ...
    '=': function equal(query, insensitive) {
        const regVal = `^${(0, lodash_escaperegexp_1.default)(query[0])}$`;
...
},{"lodash.escaperegexp":1}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
let separators = /[ ;,\t\r\n]/;
/**
