...
define(["module"], function (module) {
  ...
  function similarityMatrix(v, w, scores) {
    scores = scores || {};
    var match = scores.match || +1;
    var mismatch = scores.mismatch || -1;
    var vocab = vocabulary(v + w);
    var matrix = {};
  ...
  function scoringMatrix(options) {
    var v = options.v;
    var w = options.w;
    var name = options.name || 'similarity';
  ...
  function vocabulary(text) {
    var dictionary = text.split('').reduce(function (p, c) {
      p[c] = 1;
      return p;
    }, {});
