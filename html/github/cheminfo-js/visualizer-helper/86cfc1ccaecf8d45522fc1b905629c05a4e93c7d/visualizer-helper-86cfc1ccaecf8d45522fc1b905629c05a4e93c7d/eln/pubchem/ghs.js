        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _options$detailed = options.detailed, detailed = _options$detailed === void 0 ? false : _options$detailed;
              _context2.next = 4;
              return API.require('https://www.lactame.com/lib/pubchem/0.2.0/pubchem.js');

            case 4:
              _yield$API$require = _context2.sent;
              Compound = _yield$API$require.Compound;
              _context2.next = 8;
              return Compound.fromSmiles(String(smiles));

            case 8:
              compound = _context2.sent;
              _context2.next = 11;
              return compound.getData();

            case 11:
              compoundData = _context2.sent;
              ghs = compoundData.ghs;
              ghsFull = compoundData.getGHS();
              ...
              _context2.next = 17;
              return UI.renderTwig(ghsFullTemplate, {
                ghsFull: ghsFull
              });
            ...
            case 20:
              _context2.next = 22;
              return UI.renderTwig(ghsTemplate, {
                ghs: ghs
              });
